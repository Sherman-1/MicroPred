...
def get_input_data():
    ...
    fastas = {
        ...
        "null_predicted" : "/store/EQUIPES/BIM/MEMBERS/simon.herman/Uniprot/Trembl_null_predicted.faa"
    }
...
def main():
    ...
    train_ds.save_to_disk("/store/EQUIPES/BIM/MEMBERS/simon.herman/MicroPred/data/training_dataset/new_training_dataset_null")
    eval_ds.save_to_disk("/store/EQUIPES/BIM/MEMBERS/simon.herman/MicroPred/data/training_dataset/new_eval_dataset_null")
    ...
    training_args = TrainingArguments(
        ...
        output_dir="/store/EQUIPES/BIM/MEMBERS/simon.herman/MicroPred/models/new_FT_MLP_null",
        num_train_epochs=5,
    ...
    wandb.init(project="new_FT_MLP_null", name="FT_DeepSpeed")
