...
def get_input_data():
    ...
    fastas = {
        ...
        "globular" : "/store/EQUIPES/BIM/MEMBERS/simon.herman/MicroPred/data/new_processed_fastas_shufGlob/globular_homologs_representatives_standard.fasta",
        "molten" : "/store/EQUIPES/BIM/MEMBERS/simon.herman/MicroPred/data/new_processed_fastas_shufGlob/molten_homologs_representatives.fasta",
        "transmembrane" : "/store/EQUIPES/BIM/MEMBERS/simon.herman/MicroPred/data/new_processed_fastas_shufGlob/transmembrane_elongated_representatives.fasta",
        "disordered" : "/store/EQUIPES/BIM/MEMBERS/simon.herman/MicroPred/data/new_processed_fastas_shufGlob/representative_disordered_sequences.fasta",
        "shuffled_globular" : "/store/EQUIPES/BIM/MEMBERS/simon.herman/MicroPred/data/new_processed_fastas_shufGlob/globular_homologs_representatives_shuffled.fasta"
    }
    ...
    save_fasta(train_df, "/store/EQUIPES/BIM/MEMBERS/simon.herman/MicroPred/shuffGlob_train_set.fasta")
    save_fasta(eval_df, "/store/EQUIPES/BIM/MEMBERS/simon.herman/MicroPred/shuffGlob_eval_set.fasta")
...
def main():
    ...
    train_ds.save_to_disk("/store/EQUIPES/BIM/MEMBERS/simon.herman/MicroPred/data/training_dataset/shufGlob_training_dataset")
    eval_ds.save_to_disk("/store/EQUIPES/BIM/MEMBERS/simon.herman/MicroPred/data/training_dataset/shufGlob_eval_dataset")
    ...
    training_args = TrainingArguments(
        ...
        output_dir="/store/EQUIPES/BIM/MEMBERS/simon.herman/MicroPred/models/shufGlob_FT_MLP",
        num_train_epochs=3,
    ...
    wandb.init(project="shufGlob_FT_MLP", name="FT_DeepSpeed")
