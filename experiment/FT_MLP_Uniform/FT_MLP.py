...
def get_input_data():
    ...
    fastas = {
        ...
        "globular" : "/store/EQUIPES/BIM/MEMBERS/simon.herman/MicroPred/data/uniform_processed_fastas/globular_uniform_homologs_representatives.part_001.fasta",
        "molten" : "/store/EQUIPES/BIM/MEMBERS/simon.herman/MicroPred/data/uniform_processed_fastas/molten_uniform_homologs_representatives.part_001.fasta",
        "transmembrane" : "/store/EQUIPES/BIM/MEMBERS/simon.herman/MicroPred/data/uniform_processed_fastas/transmembrane_elongated_uniform_representatives.fasta",
        "disordered" : "/store/EQUIPES/BIM/MEMBERS/simon.herman/MicroPred/data/uniform_processed_fastas/representative_disordered_uniform_sequences.fasta",
        "shuffled_globular_molten" : "/store/EQUIPES/BIM/MEMBERS/simon.herman/MicroPred/data/uniform_processed_fastas/shuffled_glob_molten.faa"
    }

    # better hard written vs list(dict.keys()),
    ...
    save_fasta(train_df, "/store/EQUIPES/BIM/MEMBERS/simon.herman/MicroPred/uniform_train_set.fasta")
    save_fasta(eval_df, "/store/EQUIPES/BIM/MEMBERS/simon.herman/MicroPred/uniform_eval_set.fasta")
...
def main():
    ...
    train_ds.save_to_disk("/store/EQUIPES/BIM/MEMBERS/simon.herman/MicroPred/data/training_dataset/uniform_train_dataset")
    eval_ds.save_to_disk("/store/EQUIPES/BIM/MEMBERS/simon.herman/MicroPred/data/training_dataset/uniform_eval_dataset")
    ...
    training_args = TrainingArguments(
        ...
        output_dir="/store/EQUIPES/BIM/MEMBERS/simon.herman/MicroPred/models/uniform_FT_MLP",
        num_train_epochs=3,
    ...
    wandb.init(project="uniform_FT_MLP", name="FT_DeepSpeed")
    ...
    CLASS_NAMES = ["molten", "globular", "transmembrane", "disordered", "shuffled_globular_molten"]

    report = classification_report(true_labels, preds, target_names=CLASS_NAMES, digits=2)
