...
class CLASSIF_REG_MHAP(nn.Module):
    def __init__(self, input_embed_dim: int, output_embed_dim: int, hidden_dim: int, num_classes: int, descriptors_dim: int, device, class_weights = None):
    ...
    def forward(self, embeddings, attention_mask, labels = None, phychem_descriptors = None):
